...
from webui.forms import WeeklyPlannerForm, STARTERS, MAIN_COURSES, DINNER
...
def index():
    ...
    if form.validate_on_submit():
        ...
        if form.saturday_dinner.data and form.saturday_dinner.data != DINNER[0][0]:
        ...
        if form.sunday_dinner.data and form.sunday_dinner.data != DINNER[0][0]:
        ...
        if form.monday_dinner.data and form.monday_dinner.data != DINNER[0][0]:
        ...
        if form.tuesday_dinner.data and form.tuesday_dinner.data != DINNER[0][0]:
        ...
        if form.wednesday_dinner.data and form.wednesday_dinner.data != DINNER[0][0]:
        ...
        if form.thursday_dinner.data and form.thursday_dinner.data != DINNER[0][0]:
        ...
        if form.friday_dinner.data and form.friday_dinner.data != DINNER[0][0]:
