...
STARTERS = [('---', '---'), 
            ...
            ('Garbanzos con Langostinos', 'Garbanzos con Langostinos'),
            ('Lentejas con Rape', 'Lentejas con Rape'), 
            ('Judias Verdes', 'Judias Verdes'),
            ('Crema de Calabacín', 'Crema de Calabacín'),
            ...
            ('Lasaña de Espinacas','Lasaña de Espinacas'),
            ('Sopa Cocido','Sopa Cocido'),]
